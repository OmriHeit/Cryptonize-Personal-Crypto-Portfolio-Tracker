    ...
    <div className="w-full flex items-center justify-center space-x-2 sm:space-x-4 mb-4">
      <button
        ...
        className={`tab-btn flex-shrink-0 px-2 sm:px-4 py-1 sm:py-2 text-sm sm:text-lg font-bold border-b-4 
          ${activeButton === 'assets' ? 'text-blue-400 border-blue-400' : 'border-transparent'}
          hover:text-blue-400 hover:border-blue-400 transition duration-300`}
      >
        Assets
      </button>
      <button
        ...
        className={`tab-btn flex-shrink-0 px-2 sm:px-4 py-1 sm:py-2 text-sm sm:text-lg font-bold border-b-4 
          ${activeButton === 'transactions' ? 'text-blue-400 border-blue-400' : 'border-transparent'}
          hover:text-blue-400 hover:border-blue-400 transition duration-300`}
      >
        Transactions
      </button>
      <button
        ...
        className={`tab-btn flex-shrink-0 px-2 sm:px-4 py-1 sm:py-2 text-sm sm:text-lg font-bold border-b-4 
          ${activeButton === 'BestPerforming' ? 'text-blue-400 border-blue-400' : 'border-transparent'}
          hover:text-blue-400 hover:border-blue-400 transition duration-300`}
      >
        Best Performing
      </button>
